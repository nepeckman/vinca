...
proc generateLinkerProc*(path: Path, renderProc: NimNode, isPage: bool, router: NimNode): NimNode =
    ...
    let base = if isPage: newStrLitNode("") else: quote do: `router`.componentPath
